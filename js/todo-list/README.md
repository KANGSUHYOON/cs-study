...
| 파일 | 역할 |
| --- | --- |
| `index.html` | TODO 화면 구조 |
| `style.css` | 프론트엔드 스타일 |
| `script.js` | 화면 렌더링과 사용자 이벤트 처리 |
...
VS Code에서 `index.html`을 열고 Live Server로 실행합니다.
